...
public class GTUVector<T> extends GTUContainer<T>{
	...
	public void erase( T element )
	{
		if(this.contains( element ))
		{
			...
			System.err.printf("%s could not be found in the vector\n", element);
	}
